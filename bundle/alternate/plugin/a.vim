...
call <SID>AddAlternateExtensionMapping('hxx',"c,cpp,cxx,cc,CC")
call <SID>AddAlternateExtensionMapping('H',"C,CPP,CXX,CC")
call <SID>AddAlternateExtensionMapping('hpp',"cpp,ipp,c")
...
call <SID>AddAlternateExtensionMapping('ipp',"hpp")
call <SID>AddAlternateExtensionMapping('CPP',"H,HPP")
